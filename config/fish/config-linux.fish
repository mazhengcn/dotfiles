...
# Homebrew must already exist by the time this config runs.  Install
# Homebrew to $HOME/.linuxbrew (no separate linuxbrew user needed):
#   /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)"
# The installer will prompt for a prefix — use ~/.linuxbrew.
